export const FCM_TEMPLATES = {
  ...
  RESERVATION_ONE_HOUR_BEFORE: {
    ...
    message: (reservationTitle: string) => `'${reservationTitle}' 예약까지 1시간 남았어요. 준비 상태를 업데이트하세요`,
  },
  RESERVATION_THIRTY_MIN_BEFORE: {
    title: (reservationTitle: string) => `'${reservationTitle}' 예약까지 30분`,
    message: (reservationTitle: string) => `'${reservationTitle}' 예약까지 30분 남았어요. 예약 준비를 시작하세요!`,
  },
  RESERVATION_FIVE_MIN_BEFORE: {
    title: (reservationTitle: string) => `'${reservationTitle}' 예약까지 5분`,
    message: (reservationTitle: string) => `'${reservationTitle}' 예약까지 5분 남았어요. 서둘러 예약을 준비하세요!`,
  },
